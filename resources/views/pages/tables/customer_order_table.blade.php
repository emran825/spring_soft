                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($order as $key =>  $order)
                        ...
                        <td>{{$order->order_total  }}</td>
                         ...
                         <span class="badge badge-danger"> {{$order->shipping->shipping_status  }}</span>
                         @else
                         ...
                         <td><a  href="{{ route('Order.Details',['id'=>$order->id]) }}">Details</a> || <a  href="{{ route('Shipping.Details',['id'=>$order->shipping_id]) }}">Shipping</a> </td>
